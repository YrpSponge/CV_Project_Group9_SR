...
def main():
    ...
    parser.add_argument("--dlora_python", type=str, default="python", help="Python executable for DLoRA environment")
    parser.add_argument("--dlora_script_path", type=str, default="dloral_keyframe.py", help="Path to dloral_keyframe.py")
    ...
    for video_path in tqdm(video_files, desc="Processing videos"):
        ...
        if args.ref_mode == "no_ref":
            ...
            ref_indices = []
             ...
             dlora_python = args.dlora_python
             dlora_script = args.dlora_script_path
